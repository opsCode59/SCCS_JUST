...
namespace API.Migrations
{
    ...
    [Migration("20240528064213_addpostdb")]
            ...
            modelBuilder.Entity("API.Entities.Appointment", b =>
                {
                    ...
                    b.Property<string>("clinicUsername")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("API.Entities.UserLike", b =>
                {
                    b.HasOne("API.Entities.AppUser", "SourceUser")
                        .WithOne("LikedUser")
                        .HasForeignKey("API.Entities.UserLike", "SourceUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API.Entities.AppUser", "TargetUser")
                        .WithOne("LikedByUser")
                        .HasForeignKey("API.Entities.UserLike", "TargetUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
